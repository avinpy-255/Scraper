    ...
    <section className='px-6 border-2 md:px-20 py-24 border-slate-900 bg-slate-500'>
     <div className='flex max-xl:flex-col gap-16'>
       <div className='flex flex-col justify-center'>
        <h1 className=' head-text text-slate-900'>Scraper is a web scraping tool that allows you to scrape data from <span className='text-blue-700'>websites</span>.</h1>
        <Searchbar/>      
       </div>
     </div>
    </section>
